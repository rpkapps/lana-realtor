...
var $filterBar = $("#filterBar"),
  ...
  $minAcresFilters = $("#filterMinAcres > .form-control"),
  $maxAcresFilters = $("#filterMaxAcres > .form-control"),
...
var filters = [
  ...
  },
  {
    ...
    $min: $minAcresFilters,
    $max: $maxAcresFilters,
    $elems: $minAcresFilters.add($maxAcresFilters),
    eventType: "change",
    updateTabText: updateAcresTab,
    update: updateMinMax
  }
];
...
$.subscribe("snavbar.type", function(event, checkbox) {
  var $filter = $propertyTypeFilters.filter(
...
/**
 * Update acres tab text
 */
function updateAcresTab() {
  updateTabForMinMax({
    $elem: this.$min,
    minVal: parseInt(this.$min.val()),
    maxVal: parseInt(this.$max.val()),
