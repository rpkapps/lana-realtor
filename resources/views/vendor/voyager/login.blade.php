...
<head>
    ...
    <style>
        ...
        body.login .login-sidebar{
            border-top:5px solid {{ config('voyager.primary_color','#cb3849') }};
        }
        @media (max-width: 767px) {
            .login-sidebar {
                border-top:0px !important;
                border-left:5px solid {{ config('voyager.primary_color','#cb3849') }};
            }
        }
        body.login .form-group-default.focused{
            border-color:{{ config('voyager.primary_color','#cb3849') }};
        }
        .login-button, .bar:before, .bar:after{
            background:{{ config('voyager.primary_color','#cb3849') }};
        }
    </style>
